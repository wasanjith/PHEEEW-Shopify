              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    ...
                    title: Text(
                        "${totalQuantityCalculator(orders[index].products)} Items Worth RS ${orders[index].total}"),
                    subtitle: Text(
                    ...
                    .map((e) => Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "RS.${e.single_price.toString()} x ${e.quantity.toString()} quantity",
                                style: TextStyle(fontWeight: FontWeight.bold),
                              ),
                              Text(
                                "RS.${e.total_price.toString()}",
                                style: TextStyle(
